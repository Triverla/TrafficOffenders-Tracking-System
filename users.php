...
View Users		<ul class="breadcrumb"><li><a href="index.php">Home</a></li>
						<li><a href="#" title="News &amp; Events">View All Users</a></li>
						</ul>
		</h1>
</div>
</div>
            ...
            <?php
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        echo "<td style='word-wrap: break-word'><i>". $row['phone']."</i></td>";
                                        echo "<td><i>". $row['address']."</i></td>";
                                        echo "<td style='word-wrap: break-word'><i>". $row['idcardno']."</i></td>";
